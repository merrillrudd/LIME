...
create_inputs <- function(param, val, lh_list, data_avail_list){
        ...
        if(obs_lb > max(dat_input$highs)){
            ...
            dat_input$mids <- c(dat_input$mids, seq(from=(max(dat_input$mids)+dat_input$binwidth), obs_lb, by=dat_input$binwidth))
            dat_input$lows <- c(dat_input$lows, seq(from=(max(dat_input$lows)+dat_input$binwidth), obs_lb, by=dat_input$binwidth))
        }
