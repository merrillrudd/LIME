...
for(dd in 1:length(alldirs)){
	...
	ignore <- runModel(modpath=alldirs[dd], itervec=NULL, est_sigma=est_sigma, data_avail=data_avail, lh_list=lh, rewrite=TRUE, start_f=0, simulation=FALSE, input_data=data)
}
